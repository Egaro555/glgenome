...
// glgenome.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CglgenomeApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CglgenomeApp

CglgenomeApp::CglgenomeApp()
{
...
// Seul et unique objet CglgenomeApp

CglgenomeApp theApp;


// initialisation de CglgenomeApp

BOOL CglgenomeApp::InitInstance()
{
